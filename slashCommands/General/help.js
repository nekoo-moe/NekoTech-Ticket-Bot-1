...
module.exports = {
  ...
  async execute(interaction, client) {
    ...
    let helpEmbed = new Discord.EmbedBuilder()
      .setTitle(`${config.HelpCommand.Title.replace(/{botName}/g, `${client.user.username}`)}`)
...
// Commands list
    ...
    addCommandFields(
      ...
      [
        ...
        { Name: 'tag', Enabled: commands.Ticket.ChangeCategory.Enabled },
        { Name: 'changecategory', Enabled: commands.Ticket.Tag.Enabled }
      ]
    );
